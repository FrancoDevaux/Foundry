...
contract MockFailedTransfer is ERC20Burnable, Ownable {
    ...
    */
    ...
    function transfer(address, /*recipient*/ uint256 /*amount*/ ) public pure override returns (bool) {
        return false;
        // Este transfer() siempre devuelve false, o sea, falla la transferencia, aunque parezca que todo esté bien.
        //Esto sirve para testear que, si un token falla internamente, tu contrato que lo usa detecta el error y revierte como corresponde.
    }
}
