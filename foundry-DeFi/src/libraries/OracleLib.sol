...
library OracleLib {
    ...
    uint256 private constant TIMEOUT = 3 hours; // 3 hours = 3 * 60 * 60 seconds = 10800 seconds
        ...
        returns (uint80, int256, uint256, uint256, uint80)
    {
        ...
        uint256 secondsSince = block.timestamp - updatedAt; // Esto deberia darnos el tiempo desde la ultima actualizacion
